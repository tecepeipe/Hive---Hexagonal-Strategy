...
export const BUG_DEFINITIONS: Record<BugType, BugInfo> = {
  ...
  SPIDER: {
    ...
    name: 'Spider',
    emoji: '🕷️',
    description: 'Moves exactly 3 spaces around the hive perimeter without backtracking.',
    count: 2,
  },
  BEETLE: {
    type: 'BEETLE',
  ...
  MOSQUITO: {
    ...
    name: 'Mosquito',
    emoji: '🦟',
    description: 'Copies movement ability of any adjacent piece touching it (acts like Beetle on top of hive).',
    count: 1,
    isExpansion: true,
  },
  LADYBUG: {
    ...
    name: 'Ladybug',
    emoji: '🐞',
    description: 'Moves exactly 3 spaces: 2 spaces on top of the hive and 1 space down.',
    count: 1,
    isExpansion: true,
  },
  PILLBUG: {
